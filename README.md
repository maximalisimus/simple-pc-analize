...
Теперь выделите все файлы и папки и распакуйте согласно архитектуре в созданную выше одну из папок в вашем локальном диске, например **C:\Portable-Programs\Python-3.8.9-x86** один **exe** архив и **C:\Portable-Programs\Python-3.8.9-x64** другой **exe** архив.
