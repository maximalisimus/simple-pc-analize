...
Общая команда для установки внутри виртуального окружения:
...
```
> simplepca.exe -h
usage: simplepca.exe [-h] [-v] [-nc] [-np] [-pn] [-nf] [-ns] [-nbi] [-nhf]
                     [-ndi] [-nui] [-nnn] [-nii] [-nci] [-nvi] [-nmi] [-nni]
                     [-nsd] [-nuc] [-pf PINGFILE] [-c COUNT] [-i INTERVAL]
                     [-s SIZE] [-S SRCADDR] [-t TIMEOUT] [-nde] [-nq]
...
расширенное:
  Изменение получения расширенной информации о дисках ПК.
...
Базовое:
  Изменение вывода базовой информации.

  -nbi, --nobasicinfo		Не читать и не записывать базовую информацию.
  -nhf, --nohostfile		Не читать и не записывать данные из файла hosts.
  -ndi, --nodiskinfo		Не читать и не записывать данные о размерах локальных дисков.
  -nui, --nouserinfo		Не читать и не записывать данные о пользователях системы.
  -nnn, --nonetworkname
				Не читать и не записывать сетевое имя пользователя.
  -nii, --noipinfo		Не читать и не записывать данные о локальном ip адресе.
  -nci, --nocpuinfo		Не читать и не записывать подробные данные о процессоре.
  -nvi, --novideoinfo		Не читать и не записывать данные о видеокарте.
  -nmi, --nomemoryinfo		Не читать и не записывать данные об оперативной памяти.
  -nni, --nonetworkinfo
				Не читать и не записывать данные о сетевых адаптерах ПК.
  -nsd, --nosounddevice
				Не читать и не записывать данные об аудокарте ПК.
  -nuc, --nousbcontrollers
				Не читать и не записывать данные о USB контролерах.

Пинг:
  Изменение настроек пинга.

  -pf PINGFILE, --pingfile PINGFILE
				Файл со списком адресов для пинга.
  -c COUNT, --oncount COUNT
				Количество эхо-запросов для отправки.
  -i INTERVAL, --oninterval INTERVAL
				Интервал в секундах между отправкой каждого пакета.
  -s SIZE, --onsize SIZE
				Размер буфера отправки.
  -S SRCADDR, --srcaddr SRCADDR
				Исходный адрес для использования.
  -t TIMEOUT, --ontimeout TIMEOUT
				Максимальное время ожидания получения ответа в секундах.

Лог:
  Изменение расположения папок журналов.

  -nde, --nodatayear		Не сортировать файлы журналов по годам.
...
Если просто запустить утилиту без параметров и ключей - то вся заданная диагностика будет записана в файл журнала. Ключи и параметры призваны отключать какую-либо диагностику и / или изменять структуру папок журналов.
